...
module.exports = () => {
    ...
    Fs.readdirSync(__dirname)
        ...
        .forEach((file) => {
            ...
            models[model.name].validate = require(path.join(__dirname, file)).validate;
        ...
        changedKeys.forEach(function (fieldName) {
            ...
            if (validation.error) {
                validation.error.details.forEach(function (joiValidationError) {
                    ...
                    const error = new SequelizeDB.ValidationErrorItem(errorMessage, errorType, errorPath, errorValue, instance)
